...
function Projects() {
  return (
    <section id="projects">
      <h1 className="career">CAREER OBJECTIVE</h1>
      ...
      <h1 className="work">RECENT WORK</h1>
            ...
            <div className="projectText">
              ...
              <div className="cardLinks">
                <button className="btn-grad">
                  <a
                    href="https://capstone-project-671d63.netlify.app/"
                    target="_blank"
          ...
          <div className="cardHead">
            ...
            <div className="projectText">
              ...
              <div className="cardLinks">
                <button className="btn-grad">
                  <a
                    href="https://github.com/Praveen-S22/webScrapping-Ecommerce-Frontend"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <BsGithub size={15} />
